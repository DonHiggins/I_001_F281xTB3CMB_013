...
const char *version = "V03.01.06\0";
const char *ts_dateStamp = "07/23/2018\0";
const char *ts_timeStamp = "10:41\0";
...
const Uint16 timeStamp_t3 = 0x41A5; // BCD MnA5 (0x25A5 => 25 min past the hour, A5 is a constant)
const Uint16 revision_rv1 = 0x0301; // 2 binary bytes A.B
const Uint16 revision_rv2 = 0x0600; // 2 binary bytes C.0 (version is A.B.C, 0 indicates DSP)
